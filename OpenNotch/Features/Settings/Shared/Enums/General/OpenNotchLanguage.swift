...
enum OpenNotchLanguage: String, CaseIterable, Identifiable {
    case system
    case english = "en"
    case russian = "ru"
    case spanish = "es"
    ...
    static func resolved(_ rawValue: String?) -> OpenNotchLanguage {
        guard let rawValue, let language = OpenNotchLanguage(rawValue: rawValue) else {
            return .system
        }
